...
| navlist              | []                          | 海报列表项                      |
| navlist.container    | {}                          | 设置字段img、nav的整体样式           |
| navlist.size         | {}，有默认值可不设置                 | 设置img图标的大小                 |
...
| navlist[].groupFirst | 选项[true,false]              | Row需要分组时，每个分组的第一个元素配置为true |
...
| 子类型名称            | 子类型说明                         | 所有属性                                         |
| ---------------- | ----------------------------- | -------------------------------------------- |
| MagicItem        | 一个图标在上，标题在下的路由导航栏             | `[img,color,title,nav,container]`            |
| CardItem         | 一个图标在左，标题再右的路由导航栏             | `[img,color,title,nav,container]`            |
| SubtitleCardItem | 同`CardItem`, 有副标题属性的路由导航栏     | `[img,color,title,subtitle,nav,container]`   |
| RowItem          | 一个图标在左侧, 紧靠标题, 右侧是箭头          | `[img,color,title,nav，groupFirst,container]` |
| BoxItem          | 统计数字在上，标题在下的统计项，无路由属性, 有数据值格式 | `[number,title,format,container]`            |
 ...
 {  
    ...
    "moduleData": {
        "d4a555sd-hf22-qqds-8412-16234da445885": {
            ...
            "navList": [
                {
                    "img":"http://static.smallsaas.cn/house/2022/svg/senior/Community.svg?color=628ca2",
                    "title":"创建小区",
                ...
                {
                    "img":"http://static.smallsaas.cn/house/2022/svg/senior/Community.svg?color=ffa378",
                    "title":"创建楼栋",
                ...
                {
                    "img":"http://static.smallsaas.cn/house/2022/svg/senior/floor.svg?color=f21137",
                    "title":"设置楼层",
                ...
                {
                    "img":"http://static.smallsaas.cn/house/2022/svg/senior/userSet.svg?color=e28e74",
                    "title":"用户类型设置",
                ...
                {
                    "img":"http://static.smallsaas.cn/house/2022/svg/senior/Inquire.svg?color=5eb670",
                    "title":"产权申请处理",
                ...
                {
                    "img":"http://static.smallsaas.cn/house/2022/svg/senior/RoomChangeRecords.svg?color=#4789dc",
                    "title":"换房匹配报表",
                ...
                {
                    "img":"http://static.smallsaas.cn/house/2022/svg/senior/InformationSettings.svg?color=687477",
                    "title":"小区信息配置",
                    "nav":"",
                    "groupFirst":true,
                     "container":{
                ...
                {
                    "img":"http://static.smallsaas.cn/house/2022/svg/senior/InformationSettings.svg?color=edb518",
                    "title":"小区统计详细",
                    "nav":"",
                     "container":{
                        "background":"white"
