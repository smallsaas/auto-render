...
| multiFilter     | 组合过滤查询条件 `[{"field":"location","name":"户型", "options":["name":"一房一厅","value":"oneroom"]}]` | [] |
...
| 属性          | 说明                   | 默认值 |
| ------------- | ---------------------- | ------ |
| multiFilterModule[].field | API 过滤字段属性 |   |
| multiFilterModule[].name  | 过滤条件显示名称 |   |
| multiFilterModule[].options  | 过滤条件选项 |   |
| multiFilterModule[].options[].name | 条件选项显示名称 |   |
| multiFilterModule[].options[].value | 条件选项`API`查询条件 |   |
